                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          Provider.of<RecipeClass>(context, listen: false)
                              .filterRecipesByCategory(categories[i].name);
                  ...
                  child: Consumer<RecipeClass>(
                    builder: (BuildContext context, myProvider, Widget? child) {
                      return GridView.builder(
                        ...
                        itemCount: myProvider.filteredRecipes.isNotEmpty
                            ? myProvider.filteredRecipes.length
                            : myProvider.allRecipes.length,
                        itemBuilder: (context, index) {
                          return RecipeWidget(
                              myProvider.filteredRecipes.isNotEmpty
                                  ? myProvider.filteredRecipes[index]
                                  : myProvider.allRecipes[index]);
                        },
                      );
                    },
                  ),
